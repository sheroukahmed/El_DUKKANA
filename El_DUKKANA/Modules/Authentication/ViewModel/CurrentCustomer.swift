...
class CurrentCustomer{
    ...
    static var currentCartDraftOrder : DraftOrderRequest = DraftOrderRequest(draft_order: DraftOrder(id: cartDraftOrderId, email: nil, currency: nil, created_at: nil, updated_at: nil, completed_at: nil, name: nil, status: nil, line_items: [], order_id: nil, shipping_line: nil, tags: nil, total_price: nil, customer: currentCustomer,shipping_address: CustomerAddress()))
    static var currentFavDraftOrder : DraftOrderRequest = DraftOrderRequest(draft_order: DraftOrder(id: favDraftOrderId, email: nil, currency: nil, created_at: nil, updated_at: nil, completed_at: nil, name: nil, status: nil, line_items: [], order_id: nil, shipping_line: nil, tags: nil, total_price: nil, customer: currentCustomer,shipping_address: CustomerAddress()))
